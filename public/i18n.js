(function () {
  const messages = {
    'zh-CN': {
      ...
      shareEnded: '分享已停止',
      shareEndedHint: '对方已停止分享，重新开启后请刷新页面。',
      refreshPage: '刷新页面',
      uploadStopped: '分享已停止，请在重新连接后检查上传结果',
      sharing: '共享中',
      ...
      uploadDone: '上传完成',
      uploadTasks: '上传任务',
      uploadSummary: '{active} 个进行中 · {done} 个完成',
      uploadSummaryFailed: ' · {failed} 个失败',
      uploadKeepOpen: '可关闭此弹窗，上传期间请勿关闭网页',
      clearUploads: '清除已结束',
      uploadQueued: '等待上传',
      uploadSending: '上传中 {percent}%',
      uploadSaving: '正在保存…',
      uploadSaved: '已加入共享列表',
      uploadCancelled: '已取消',
      uploadCancel: '取消',
      uploadRetry: '重试',
      uploadView: '查看文件',
      uploadNetworkError: '连接中断，请检查网络后重试',
      uploadUnexpectedResponse: '服务器未确认上传结果，请检查共享列表',
      uploadStalled: '传输暂未推进，正在等待网络',
      uploadEmptySelection: '没有可上传的非空文件',
    ...
    'en-US': {
      ...
      shareEnded: 'Sharing has stopped',
      shareEndedHint: 'The host stopped sharing. Refresh this page after sharing resumes.',
      refreshPage: 'Refresh page',
      uploadStopped: 'Sharing stopped. Check the upload result after reconnecting.',
      sharing: 'Sharing',
      ...
      uploadDone: 'Uploaded',
      uploadTasks: 'Uploads',
      uploadSummary: '{active} active · {done} completed',
      uploadSummaryFailed: ' · {failed} failed',
      uploadKeepOpen: 'You can close this dialog. Keep the webpage open while uploading.',
      clearUploads: 'Clear finished',
      uploadQueued: 'Queued',
      uploadSending: 'Uploading {percent}%',
      uploadSaving: 'Saving…',
      uploadSaved: 'Added to shared files',
      uploadCancelled: 'Cancelled',
      uploadCancel: 'Cancel',
      uploadRetry: 'Retry',
      uploadView: 'View file',
      uploadNetworkError: 'Connection lost. Check your network and retry.',
      uploadUnexpectedResponse: 'Upload not confirmed. Check the shared list.',
      uploadStalled: 'Transfer stalled. Waiting for the network.',
      uploadEmptySelection: 'No non-empty files to upload',
